  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden ">
      ...
      <div className="relative z-10 max-w-[2000px] mx-auto px-4 lg:px-8 flex flex-col items-center text-center">
        ...
        <p
          className="text-gray-300 text-lg md:text-xl max-w-2xl mb-8  animate-fade-in-up"
          style={{ animationDelay: "0.6s" }}
        >
          Discover premium sports gear designed for athletes who demand
          excellence. Quality, innovation, and performance in every product.
        </p>
        ...
        {/* Stats */}
        {/* <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-16  animate-fade-in-up">
          <div>
