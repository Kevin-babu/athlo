        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-gray-400 text-lg mb-8 max-w-lg">
              Discover our latest collection of premium sports gear designed for
              peak performance. Engineered for athletes who demand excellence.
            </p>
            <Link
              href="/shop"
